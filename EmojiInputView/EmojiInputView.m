...
- (id)init
{
    ...
    if (self)
    {
        ...
        UIImageView *bottomImageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 162, UI_SCREEN_WIDTH, 54)];
        bottomImageView.image = nil;//[UIImage imageNamed:@"emoji_keybord_bottom"];
